...
- start using math module refer to index.js and math.js
- while importing remove the module in math.js and in the package.js change the type to module from common js

-create a server without express

start with the express.js
